...
public class AdminController {
    ...
    {
       File file=new File("C:\\\\Users\\\\Lcode064\\\\Documents\\\\NetBeansProjects\\\\1\\\\src\\\\pkg1\\\\crypto.txt");    
    ...
    {
        File file=new File("C:\\\\Users\\\\Lcode064\\\\Documents\\\\NetBeansProjects\\\\1\\\\src\\\\pkg1\\\\wallet.txt");    
        Desktop.getDesktop().print(file);
    }
    ...
    {
        File file=new File("C:\\\\Users\\\\Lcode064\\\\Documents\\\\NetBeansProjects\\\\1\\\\src\\\\pkg1\\\\login.txt");    
        Desktop.getDesktop().print(file);
    ...
    {
        File file=new File("C:\\\\Users\\\\Lcode064\\\\Documents\\\\NetBeansProjects\\\\1\\\\src\\\\pkg1\\\\fees.txt");    
        Desktop.getDesktop().print(file);
    }
    ...
    void registrationrecords(ActionEvent event) throws FileNotFoundException, IOException
    {
        ...
        File file=new File("C:\\\\Users\\\\Lcode064\\\\Documents\\\\NetBeansProjects\\\\1\\\\src\\\\pkg1\\\\reg.txt");    
        Desktop.getDesktop().print(file);
    }
