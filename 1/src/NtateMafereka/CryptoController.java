...
public class CryptoController implements Initializable
{
   ...
   @FXML
    ...
    void convertMoney(ActionEvent event) throws IOException
    {
       ...
       String url="C:\\Users\\Lcode064\\Documents\\NetBeansProjects\\1\\src\\pkg1\\crypto.txt";
       java.io.FileWriter mf=new java.io.FileWriter(url,true);
        try (BufferedWriter bf = new BufferedWriter(mf)) {
